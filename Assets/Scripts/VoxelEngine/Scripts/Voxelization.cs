...
public class Voxelization : MonoBehaviour {
	...
	public bool IsDebugAllBlocks = false;
	public bool IsDebugTriangleCubes = false;
	public bool IsDebugAllTriangleCubes = false;

	public float resolution = 1;
	public Mesh InputMesh;
	//public Blocks MyBlocks;	// reference to blocks I need to update
	...
	void Start() {
		...
		if (MyMeshRender == null)
			MyMeshRender = gameObject.AddComponent<MeshRenderer> ();
		...
		InputMesh = MyMeshFilter.sharedMesh;
		//ConvertTrianglesToVoxels(MyBlocks, InputMesh);
		//GetManager.GetMyDataManager().BlockStructuresList[BlockStructureIndex].MyBlocks = MyBlocks;
		//Debug.Break();
	}
	...
	void Update() 
		...
		public void ConvertTrianglesToVoxels(VoxelizationData MyBlocks, Mesh InputMesh) {
